...
class BushosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create busho" do
    assert_difference("Busho.count") do
      post bushos_url, params: { busho: { busho_name: @busho.busho_name, busho_no: @busho.busho_no } }
    end
  ...
  test "should update busho" do
    patch busho_url(@busho), params: { busho: { busho_name: @busho.busho_name, busho_no: @busho.busho_no } }
